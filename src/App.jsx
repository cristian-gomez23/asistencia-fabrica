    ...
    <div class="wrap">
      ...
      <table>
        ...
        <tbody>
          ...
          ${monotributo>0?row("Monotributo","—","—",fmt(monotributo),"detail","",true):""}
...
function AppMain({ session }) {
  ...
  const iniciarPeriodo = useCallback((nombrePeriodo, desde, hasta) => {
    ...
    const RESET = [
      ...
      "monotributo",                               // adicional en mano del mes
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,alignItems:"start"}}>
                  ...
                  <div >
                    ...
                    <div style={{background:COL.surface,border:`1px solid ${COL.border}`,borderRadius:12,padding:"18px 20px",marginBottom:16}}>
                      ...
                      <FieldInput label="Monotributo"              value={p.monotributo||""} onChange={v=>setP("monotributo",v)} note="importe directo (en mano)" />
                    ...
                    <div style={{background:COL.surface,border:`1px solid ${COL.border}`,borderRadius:12,overflow:"hidden"}}>
                      ...
                      <table style={{...S.table,fontSize:12}}>
                        ...
                        <tbody>
                          ...
                          <LiqRow label="Monotributo"        indent cantidad="" valor="" importe={monotributo?fmt(monotributo):"—"} />
