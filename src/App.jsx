...
function calcRecord(rec, empCfg, specialDays) {
  ...
  // Operarios: sin extra en sábados, domingos ni feriados
  // Administrativos: nunca extra automática (solo manual)
  const sinExtra   = !rec.manual && (!esOperario || (esSabado || esDomingo || esFeriado));
